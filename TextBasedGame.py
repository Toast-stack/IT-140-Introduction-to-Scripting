...
def introduction():
    ...
    print('You will be prompted to pick it up and add it to your inventory.\n')
...
while True:
    ...
    if player_move in rooms[currentRoom]:
        ...
        #if/else statements with break statement for final room
    ...
    # else statement for input validation
    else:
